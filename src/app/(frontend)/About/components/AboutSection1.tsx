    ...
    <section className="relative w-full overflow-hidden">
      ...
      >
        ...
        <div className="flex-1 p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-center">
          <h1 className="flex flex-col text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-9xl mb-4 md:mb-6 lg:mb-12 ml-2 sm:ml-6 lg:ml-12 font-light tracking-tighter text-black">
            <div className="flex">
              <TypewriterEffect
                words={["About"]}
                className="flex"
            ...
            <span className="pl-4 sm:pl-8 md:pl-12 lg:pl-24">My self</span>
          </h1>
        </div>
            ...
            <div className="mx-4 sm:mx-6 md:mx-8 lg:mx-16 text-justify pr-2 sm:pr-4 md:pr-6 lg:pr-8">
              ...
              <div className="text-black/70 text-sm sm:text-base md:text-lg space-y-2 sm:space-y-3">
                <p className="leading-relaxed">
                  <span className="text-black font-medium">Full Stack Developer</span> passionate about crafting clean,
                  intuitive web experiences.
                </p>

                <p className="leading-relaxed">
                  My tech stack includes <span className="text-black">React, Next.js</span> on the frontend with{" "}
                  <span className="text-black">Node.js, Express</span> powering the backend.
                </p>

                <p className="leading-relaxed">
                  I transform complex problems into elegant solutions through code, constantly exploring new
        ...
        <div className="absolute bottom-4 sm:bottom-6 md:bottom-8 lg:bottom-10 right-4 sm:right-6 md:right-8 lg:right-16">
          <a href="/photoo.png" download="NamraResume.pdf" target="_blank" rel="noopener noreferrer" className="block">
            <button
            ...
            >
              <FaFileAlt className="text-sm sm:text-base md:text-lg" /> My Resume
            </button>
          </a>
        </div>
      </div>
